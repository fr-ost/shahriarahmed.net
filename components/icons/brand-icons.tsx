...
/*
 * Brand marks (Lucide no longer ships brand icons). Paths are the official
 * glyphs as published by Simple Icons (CC0). Sized and coloured like Lucide
 * icons: `currentColor` fill and a `size` prop.
 */
